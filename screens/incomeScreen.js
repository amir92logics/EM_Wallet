  ...
  let data =value.map((d, k)=>{
    // console.log("data: "+typeof(this.state.allIncome));
       ...
       return(
        ...
        <Text style={{ flex: 1, alignSelf: 'stretch' ,borderWidth: 2, borderColor: 'grey',textAlign:'center',color:'#5cb85c'}}>{d.category}</Text>
        <Text style={{ flex: 1, alignSelf: 'stretch' ,borderWidth: 2, borderColor: 'grey',textAlign:'center',color:'#5cb85c'}}>{d.amount}</Text>
         <Text style={{ flex: 1, alignSelf: 'stretch' ,borderWidth: 2, borderColor: 'grey',textAlign:'center',color:'#5cb85c'}}>{d.date}</Text>
         </View>
       )
  })
  return data
