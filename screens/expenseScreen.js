  ...
  let data =value.map((d, k)=>{
    // console.log("data: "+typeof(this.state.allexpense));
       ...
       return(
        ...
        <Text style={{ flex: 1, alignSelf: 'stretch' ,borderWidth: 2, borderColor: 'grey',textAlign:'center',color:'#d9534f'}}>{d.category}</Text>
        <Text style={{ flex: 1, alignSelf: 'stretch' ,borderWidth: 2, borderColor: 'grey',textAlign:'center',color:'#d9534f'}}>{d.amount}</Text>
         <Text style={{ flex: 1, alignSelf: 'stretch' ,borderWidth: 2, borderColor: 'grey',textAlign:'center',color:'#d9534f'}}>{d.date}</Text>
         </View>
       )
  })
  return data
